...
aux1 x (n+1) = (1-x) * aux1 x n  \commentend}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment mirrorB_tree = cataB_tree ( inB_tree . (id -\ensuremath{\mathbin{-}(\Varid{g}\comp \Varid{f}))\comp (\Varid{id}\mathbin{-}}- id >< (unzip . reverse))) }{}\<[E]%
\\
\>[B]{}\Varid{mirrorB\char95 tree}\mathrel{=}\Varid{cataB\char95 tree}\;(\Varid{inB\char95 tree}\comp (\Varid{id}+((\Varid{g}\comp \Varid{f})\comp (\Varid{id}\times(\Varid{unzip}\comp \Varid{reverse}))))){}\<[E]%
\\
\>[B]{}\hsindent{16}{}\<[16]%
\>[16]{}\mathbf{where}{}\<[E]%
\\
