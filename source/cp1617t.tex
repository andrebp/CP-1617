...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inv}\;\Varid{x}\mathrel{=}\p1\comp \mathsf{for}\ \conj{\uncurry{(\mathbin{+})}}{(\mathbin{*}(\mathrm{1}\mathbin{-}\Varid{x}))\comp \p2}\ (\mathrm{1},(\mathrm{1}\mathbin{-}\Varid{x})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{genVal}\mathbin{::}\Conid{Gen}\;(\Conid{Float},\Conid{Int}){}\<[E]%
\\
\>[B]{}\Varid{genVal}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{x}\leftarrow \Varid{\Conid{Test}.\Conid{QuickCheck}.choose}\;(\mathrm{1},\mathrm{2}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{y}\leftarrow \Varid{\Conid{Test}.\Conid{QuickCheck}.choose}\;(\mathrm{1000},\mathrm{1000}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{return}\;(\Varid{x},\Varid{y}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 inv}\;\Varid{f}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{forAll}\;\Varid{genVal}\mathbin{\$}\lambda (\Varid{x},\Varid{y})\to {}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{abs}\;((\mathrm{1}\mathbin{/}\Varid{x})\mathbin{-}(\Varid{inv}\;\Varid{x}\;\Varid{y}))\mathbin{<}\Varid{f}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{types}\mathrel{=}\Varid{f}\mathbin{::}\Conid{Float}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{testInv}\;\Varid{f}\mathrel{=}\Varid{quickCheck}\;(\Varid{prop\char95 inv}\;\Varid{f}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{worker}\mathrel{=}\Varid{cataList}\;\conj{\alt{\underline{\mathrm{0}}}{\Varid{aux}}}{\alt{\underline{\Conid{True}}}{\Varid{sep}\comp \p1}}{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}\mathbf{where}{}\<[E]%
\\
\>[10]{}\hsindent{1}{}\<[11]%
\>[11]{}\Varid{sep}\mathrel{=}\Varid{cond}\;(\lambda \Varid{c}\to \Varid{c}\equiv \text{\tt '~'}\mathrel{\vee}\Varid{c}\equiv \text{\tt '\char92 n'}\mathrel{\vee}\Varid{c}\equiv \text{\tt '\char92 t'})\;\Varid{true}\;\Varid{false}{}\<[E]%
\\
\>[10]{}\hsindent{1}{}\<[11]%
\>[11]{}\Varid{aux}\mathrel{=}\Varid{cond}\;(\uncurry{(\mathrel{\wedge})}\comp \conj{\neg \comp \Varid{sep}\comp \p1}{\p2\comp \p2})\;(\succ \comp \p1\comp \p2)\;(\p1\comp \p2){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 wc}\;\Varid{x}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{wc\char95 w\char95 final}\;\Varid{x}\equiv \Varid{wc\char95 w}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{testWc}\mathrel{=}\Varid{quickCheck}\;\Varid{prop\char95 wc}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\mathsf{B}\mbox{-}\mathsf{tree} \;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{cataB\char95 tree}\;\Varid{g}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\mathsf{B}\mbox{-}\mathsf{tree} \;\Conid{A}\times(\Conid{A}\times\mathsf{B}\mbox{-}\mathsf{tree} \;\Conid{A})}^*
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{cataB\char95 tree}\;\Varid{g}\times(\map \;(\Varid{id}\times\Varid{cataB\char95 tree}\;\Varid{g}))}}
           \ar[l]_-{\ensuremath{\Varid{inB\char95 tree}}}
\\
     \ensuremath{\mathit B}
&
     \ensuremath{\mathrm{1}\mathbin{+}\mathit B\times(\Conid{A}\times\mathit B)}^*
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inB\char95 tree}\mathbin{::}()+(\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a},[\mskip1.5mu (\Varid{a},\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a})\mskip1.5mu])\to \mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{outB\char95 tree}\;(\Conid{Block}\;\{\mskip1.5mu \Varid{leftmost}\mathrel{=}\Varid{l},\Varid{block}\mathrel{=}\Varid{b}\mskip1.5mu\})\mathrel{=}i_2\;(\Varid{l},\Varid{b}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}\mathbf{where}\;\mathsf{fmap}\;\Varid{f}\mathrel{=}\Varid{cataB\char95 tree}\;(\Varid{inB\char95 tree}\comp \Varid{baseB\char95 tree}\;\Varid{f}\;\Varid{id}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
  \ensuremath{(\Conid{A}\times\Conid{A}}^*\ensuremath{)}^*
            \ar[r]_-{\ensuremath{\Varid{concat}\comp \map \;\Varid{cons}}}
&
  \ensuremath{\Conid{A}}^*            
}
\\
...
\xymatrix@C=2cm{
  \ensuremath{\Conid{A}}^*\ensuremath{\times\Conid{A}}^*
            \ar[r]_-{\ensuremath{\uncurry{(\plus )}}}
&
  \ensuremath{\Conid{A}}^*            
}
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inordB\char95 tree}\mathrel{=}\Varid{cataB\char95 tree}\;\alt{\Varid{nil}}{\mathsf{conc}\comp (\Varid{id}\times(\Varid{concat}\comp \map \;\Varid{cons}))}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
