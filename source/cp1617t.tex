...
\start
  ...
  \ensuremath{\Varid{wc\char95 w}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\mathrm{0}}

  \ensuremath{\Varid{wc\char95 w}\;(\Varid{c}\mathbin{:}\Varid{l})\mathrel{=}\mathbf{if}\;(\neg \;\Varid{sep}\;\Varid{c})\mathrel{\wedge}\Varid{lookahead\char95 sep}\;\Varid{l}\;\mathbf{then}\;\Varid{wc\char95 w}\;\Varid{l}\mathbin{+}\mathrm{1}\;\mathbf{else}\;\Varid{wc\char95 w}\;\Varid{l}}
  %
...
\start
  ...
  \ensuremath{\Varid{lookahead\char95 sep}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}}

  \ensuremath{\Varid{lookahead\char95 sep}\;(\Varid{c}\mathbin{:}\Varid{l})\mathrel{=}\Varid{sep}\;\Varid{c}}
  %
  \just={(81), def nil, def cons, (76)}
  %
  \ensuremath{\Varid{lookahead\char95 sep}\comp \Varid{nil}\mathrel{=}\underline{\Conid{True}}}

  \ensuremath{(\Varid{lookahead\char95 sep}\comp \Varid{cons})\;(\Varid{c},\Varid{l})\mathrel{=}(\Varid{sep}\comp \p1)\;(\Varid{c},\Varid{l})}
  %
  \just={(73)}
  %
  \ensuremath{\Varid{lookahead\char95 sep}\comp \Varid{nil}\mathrel{=}\underline{\Conid{True}}}

  \ensuremath{\Varid{lookahead\char95 sep}\comp \Varid{cons}\mathrel{=}\Varid{sep}\comp \p1}
\end{eqnarray*}
...
\column{14}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\commentbegin Tendo em conta as definições dos catamorfismos dadas, definir os anamorfismos correspondentes é uma tarefa bastante simples:  \commentend}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{showAlgae}\mathrel{=}\cata{\Varid{show}~\Varid{show}}_A{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
